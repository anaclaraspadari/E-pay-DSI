...
use CodeIgniter\Model;
    ...
    class Conta_Model extends Model {
        ...
        protected $allowedFields = ['usuario', 'saldo', 'saldo_poupanca'];
        ...
        public function cadastrarNovaConta($usuario, $saldo){
            $buscaConta=$this->asArray()->where(['usuario' => $usuario])->first();
            if($buscaConta==null){
                $data=[
                    'usuario'=> $usuario,
                    'saldo'=> $saldo
