...
<body>
    ...
    ?>
    <?php
        if (session()->get('cadastroFail')){
            ?>
            <div class="alert alert-danger" role="alert">
                <?php echo "<strong>". session()->getFlashdata('cadastroFail')."</strong>"; ?>
            </div>
        <?php
        }
    ?>
    <?php
        if (session()->get('messageLogoutOk')){
            ?>
            <div class="alert alert-success" role="alert">
                <?php echo `<strong>`. session()->getFlashdata('messageLogoutOk')."</strong>"; ?>
            </div>
        <?php
        }
    ?>
